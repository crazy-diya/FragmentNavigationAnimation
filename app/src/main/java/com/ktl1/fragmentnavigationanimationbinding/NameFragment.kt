...
import com.ktl1.fragmentnavigationanimationbinding.databinding.FragmentNameBinding
...
class NameFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.nextBtn.setOnClickListener {
            if(binding.nameEdt.text.isNotEmpty()){
                val bundle = bundleOf("name" to binding.nameEdt.text.toString())
